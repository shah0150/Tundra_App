...
! function (e) {
    ...
    let u = function () {
        ...
        v = (r(y), function () {
            function e(t, n, r, u) {
                let o = this;
                i(this, e), this.id = u, this.element = t, this.capture = 'undefined' != typeof n && n, this.preventDefault = 'undefined' == typeof r || r, this.state = new h['default'](u);
                let a = [];
                a = window.PointerEvent ? ['pointerdown', 'pointermove', 'pointerup'] : ['mousedown', 'mousemove', 'mouseup', 'touchstart', 'touchmove', 'touchend'], a.map(function (e) {
            ...
            return u(e, [{
                    ...
                    return r.forEach(function (r) {
                        if (t) {
                            if ('string' == typeof t && n.state.registeredGestures[t]) {
                                let u = n.state.registeredGestures[t];
                ...
                value: function (e, t) {
                    ...
                    if (!t instanceof f['default']) throw new Error('Parameter gesture is an invalid Gesture object');
                ...
                value: function (e) {
                    ...
                    let t = this.state.registeredGestures[e];
    ...
    let r = function i(e, t, r) {
        let u = this;
        n(this, i), this.element = e, Object.keys(r.registeredGestures).forEach(function (e) {
            u[e] = function (n, i) {
                return r.addBinding(u.element, e, n, i, t), u;
            };
        });
    };
    t['default'] = r;
    ...
    let r = function i(e, t, r, u, o) {
        n(this, i), this.element = e, this.gesture = t, this.handler = r, this.capture = 'undefined' != typeof u && u, this.bindOnce = 'undefined' != typeof o && o;
    };
    t['default'] = r;
}, function (e, t) {
    'use strict';
    ...
    let r = function () {
        ...
        i = function () {
            ...
            return r(e, [{
                ...
                key: 'update',
                value: function (e) {
                    for (let t in e) this[t] && (this[t] = e[t]);
                }
            }, {
                key: 'start',
                value: function (e) {
    ...
    function i(e, t) {
        let n = t.state;
        if (0 !== n.inputs.length || 'start' === l['default'].normalizeEvent(e.type)) {
            if ('undefined' != typeof e.buttons && 'end' !== l['default'].normalizeEvent(e.type) && 0 === e.buttons) return void n.resetInputs();
            if (n.updateInputs(e, t.element)) {
                let r = n.retrieveBindingsByInitialPos();
                if (r.length > 0) {
                    t.preventDefault ? (l['default'].setMSPreventDefault(t.element), e.preventDefault ? e.preventDefault() : e.returnValue = !1) : l['default'].removeMSPreventDefault(t.element);
                    let i = {},
                        u = (0, c['default'])(r, e, n);
                    u.forEach(function (t) {
                        let n = t.binding.gesture.id;
                        if (i[n]) {
                            let r = l['default'].getPropagationPath(e);
                            l['default'].getPathIndex(r, t.binding.element) < l['default'].getPathIndex(r, i[n].binding.element) && (i[n] = t);
                        } else i[n] = t;
    ...
    function n(e, t, n) {
        t.events = n;
        let i = new CustomEvent(e.gesture.getId(), {
            detail: t,
            bubbles: !0,
            cancelable: !0
        });
    ...
    let u = n(10),
        ...
        a = 0,
        s = function c(e, t) {
            i(this, c), this.originalEvent = e, this.type = o['default'].normalizeEvent(e.type), this.x = a, this.y = a;
            let n;
            if (e.touches && e.changedTouches) {
                for (let r = 0; r < e.changedTouches.length; r++)
                    if (e.changedTouches[r].identifier === t) {
                        n = e.changedTouches[r];
                        break;
                    }
            } else n = e;
            this.x = this.clientX = n.clientX, this.y = this.clientY = n.clientY, this.pageX = n.pageX, this.pageY = n.pageY, this.screenX = n.screenX, this.screenY = n.screenY;
        };
    t['default'] = s;
}, function (e, t) {
    'use strict';
    ...
    let n = 360,
        ...
        u = {
            ...
            distanceBetweenTwoPoints: function (e, t, n, r) {
                let i = Math.sqrt((t - e) * (t - e) + (r - n) * (r - n));
            ...
            getAngle: function (e, t, i, u) {
                let o = Math.atan2(u - t, i - e) * (r / Math.PI);
                return n - (o < 0 ? n + o : o);
            },
            ...
            getVelocity: function (e, t, n, r, i, u) {
                let o = this.distanceBetweenTwoPoints(e, r, t, i);
                return o / (u - n);
            },
    ...
    function i(e, t, n) {
        let r = o['default'].normalizeEvent(t.type),
            i = [];
        return e.forEach(function (e) {
            let t = e.gesture[r](n.inputs, n, e.element);
            if (t) {
                let u = [];
                n.inputs.forEach(function (e) {
                    u.push(e.current);
    ...
    let o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
            return typeof e;
        } : function (e) {
            ...
            return a(e, [{
                ...
                value: function () {
                    ...
                    return this.bindings.forEach(function (n) {
                        let r = e.inputs.filter(function (e) {
                ...
                value: function (e, t) {
                    function n(e, t, n, r) {
                        let i = I['default'].normalizeEvent(e.type),
                            o = u(t.inputs, n);
                    ...
                    switch (i) {
                        case 'TouchEvent':
                            ...
                            for (let o in e.changedTouches) e.changedTouches.hasOwnProperty(o) && I['default'].isInteger(parseInt(o)) && (r = e.changedTouches[o].identifier, n(e, this, r, t));
                            break;
                        case 'PointerEvent':
                ...
                key: 'numActiveInputs',
                value: function () {
                    let e = this.inputs.filter(function (e) {
    ...
    let a = n(14),
        ...
        f = (r(c), function (e) {
            function t(e) {
                i(this, t);
                let n = u(this, Object.getPrototypeOf(t).call(this, e));
    ...
    let a = function () {
        ...
        h = function (e) {
            function t(e) {
                i(this, t);
                let n = u(this, Object.getPrototypeOf(t).call(this));
            ...
            return o(t, e), a(t, [{
                ...
                value: function (e) {
                    if (e.length === d) {
                        let t = e[0].getGestureProgress(this.type);
                ...
                value: function (e, t, n) {
                    if (t.numActiveInputs() === d) {
                        let r = l['default'].distanceBetweenTwoPoints(e[0].current.x, e[1].current.x, e[0].current.y, e[1].current.y),
                            i = l['default'].distanceBetweenTwoPoints(e[0].previous.x, e[1].previous.x, e[0].previous.y, e[1].previous.y),
                            u = e[0].getGestureProgress(this.type);
                        if ('expand' === this.type) {
                            if (r < i) u.lastEmittedDistance = r;
                            else if (r - u.lastEmittedDistance >= this.threshold) return u.lastEmittedDistance = r, {
                                distance: r
                            };
                        } else if (r > i) u.lastEmittedDistance = r;
                        else if (r < i && u.lastEmittedDistance - r >= this.threshold) return u.lastEmittedDistance = r, {
                            distance: r
                        };
                        return null;
                    }
            ...
            return o(t, e), a(t, [{
                ...
                value: function (e) {
                    ...
                    e.forEach(function (e) {
                        let n = e.getGestureProgress(t.getId());
                ...
                value: function (e, t, n) {
                    if (this.numInputs === e.length)
                        for (var r = {
                            ...
                            let u = e[i].getGestureProgress(this.getId()),
                                o = !1;
                            if (o = Math.abs(e[i].current.y - u.lastEmitted.y) > this.threshold || Math.abs(e[i].current.x - u.lastEmitted.x) > this.threshold, !u.active || !o) return null;
                            r.data[i] = {
    ...
    let a = function () {
        ...
        p = function (e) {
            function t() {
                i(this, t);
                let e = u(this, Object.getPrototypeOf(t).call(this));
                ...
                value: function (e, t, n) {
                    if (t.numActiveInputs() <= d) {
                        ...
                        if (1 === t.numActiveInputs()) {
                            ...
                            let s = l['default'].getMidpoint(e[0].current.x, e[1].current.x, e[0].current.y, e[1].current.y);
                            i = r.x - s.x, u = r.y - s.y, o = l['default'].getRightMostInput(e);
                        }
                        let c = l['default'].getAngle(r.x, r.y, o.current.x + i, o.current.y + u),
                ...
                value: function (e, t, n) {
                    if (this.numInputs === e.length)
                        for (let r = 0; r < e.length; r++) {
                            let i = e[r].getGestureProgress(this.getId());
            ...
            return o(t, e), s(t, [{
                ...
                value: function (e) {
                    ...
                    return e.length === this.numInputs && e.forEach(function (e) {
                        let n = e.getGestureProgress(t.type);
                ...
                value: function (e, t, n) {
                    for (let r = 0; r < e.length; r++)
                        if ('move' === e[r].getCurrentEventType()) {
                            let i = e[r].current,
                                u = e[r].previous;
                            if (!d['default'].isWithin(i.x, i.y, u.x, u.y, this.tolerance)) {
                                let o = this.type;
                                return e.forEach(function (e) {
                                    e.resetProgress(o);
                                }), null;
                ...
                value: function (e) {
                    ...
                    for (var n = Number.MAX_VALUE, r = 0; r < e.length; r++) {
                        ...
                        let i = e[r].getGestureProgress(this.type);
                        if (!i.start) return null;
                        i.start < n && (n = i.start);
                    }
                    let u = (new Date).getTime() - n;
